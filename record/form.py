...
class LectureFilterForm(forms.Form):
    ...
    question_group = forms.CharField(label="Quiz", required=False, widget=forms.Select(choices=QuestionGroupChoice.choices))
    ...
    def __init__(self, lecture, *args, **kwargs):
        ...
        self.fields["course"].queryset = lecture.coursemodel_set.all()
